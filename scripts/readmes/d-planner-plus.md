...
Version 3.1.3 is the current post-2.5 milestone release after a major UI, engine, audit, export, and release-hardening overhaul.
...
- Release gates, Android APK build, offline ZIP build, and GitHub Pages deploy are green for 3.1.3.
...
The 3.1.3 release uses a simplified risk-first audit workflow. Older Seven-Lens cycle records are preserved as historical evidence, but active development uses the newer V4 risk-first records and focused regression contracts.
...
- Dive Mode icon by Flaticon: https://www.flaticon.com/free-icon/dive_6648136
