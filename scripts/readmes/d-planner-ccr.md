...
Static analysis: **324 checks** across 51 code groups (includes GROUP 51 v2.30.17 imperial SAC fix).
...
| `audit.py` | Static structural analysis — **324 checks**. Run: `python audit.py index.html` | — |
...
| `audit.py` | Static analysis (324 checks) |
