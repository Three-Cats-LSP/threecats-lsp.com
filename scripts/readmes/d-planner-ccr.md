...
Static analysis: **274 checks** across 42 code groups (includes GROUP 41 CCR + GROUP 42 v2.30.9 regression guards).
...
| `audit.py` | Static structural analysis — **274 checks**. Run: `python audit.py index.html` | — |
...
| `audit.py` | Static analysis (274 checks) |
